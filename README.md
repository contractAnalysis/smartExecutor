...
```bash
$ sudo docker run -it --rm -v a_host_directory:/home/smartExecutor/ --entrypoint semyth 2378942/smartexecutor:latest analyze ./Crowdsale.sol:Crowdsale
```
...
```bash
$ sudo docker run -it --rm --entrypoint semyth 2378942/smartexecutor:latest analyze /opt/smartExecutor/tests/testdata/solidity_files/Crowdsale.sol:Crowdsale 
```
...
```bash
$ sudo docker run -it --rm --entrypoint semyth 2378942/smartexecutor:latest -v 3 analyze /opt/smartExecutor/tests/testdata/solidity_files/Crowdsale.sol:Crowdsale 
```
